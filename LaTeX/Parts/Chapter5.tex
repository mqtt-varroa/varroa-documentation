...
\begin{itemize}
	...
	\item \textbf{clientGroupId}: identfier for the Client Group contain in the chunk.
...
When accepting the Chunk the Agents waits for a Start Message from the Commander and upon receiving it the Agent starts executing the Chunk.
