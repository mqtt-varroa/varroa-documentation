...
Then it parses the Scenario's XML. 
As soon as this is done, the Commander starts to distribute the Scenario data amongst the Agents.
After finishing this it sets its state to \emph{Scenario Data Distributed}.
After this the Commander begins to distribute the first stage to the Agents.
