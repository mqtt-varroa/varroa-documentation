...
<connect broker="b1" expectedDuration="10s" retries="10" retryInterval="20s"/>
\end{lstlisting}
...
\begin{itemize}
	...
	\item \textbf{retries (optional):} the maximum amount of retries that will be performend when the connect fails
	\item \textbf{retryInterval (optinal):} the time-span between connect attempts
\end{itemize}
